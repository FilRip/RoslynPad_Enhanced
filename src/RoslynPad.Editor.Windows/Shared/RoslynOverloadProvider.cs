...
internal sealed class RoslynOverloadProvider : NotificationObject, IOverloadProviderExtend
{
    ...
    public void Refresh()
    {
        SignatureHelpItem? _item = _items[_selectedIndex];
    ...
    private static bool HasContent(TextBlock textBlock) => textBlock?.Inlines.Count > 0;
