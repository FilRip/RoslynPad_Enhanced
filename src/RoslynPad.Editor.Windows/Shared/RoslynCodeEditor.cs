...
public class RoslynCodeEditor : CodeTextEditor
{
    ...
    public bool IsBraceCompletionEnabled
    {
        ...
        set { SetValue(IsBraceCompletionEnabledProperty, value); }
    }
    ...
    public ImageSource ContextActionsIcon
    {
        ...
        set => SetValue(ContextActionsIconProperty, value);
    }
    ...
    protected void ProcessDiagnostics(DiagnosticsUpdatedEventArgs args)
    {
    ...
    private void ProcessDiagnosticsOnUiThread(DiagnosticsUpdatedEventArgs args)
    {
...
{
    public CreatingDocumentEventArgs(AvalonEditTextContainer textContainer, Action<DiagnosticsUpdatedEventArgs> processDiagnostics)
    {
    ...
    public Action<DiagnosticsUpdatedEventArgs> ProcessDiagnostics { get; }
