...
internal sealed class VsCodeColorRegistry : IColorRegistry
{
    ...
    private static string RegisterColor(string name) => name;
    ...
    private sealed record ColorDefaults(ColorValue Light, ColorValue Dark);

    private sealed record ColorValue(string? Id = null, Color? Color = null, ColorTransform? Transform = null)
    {
    ...
    private sealed record ColorTransform(ColorTransformOp Op, ColorValue Value, double Factor);
