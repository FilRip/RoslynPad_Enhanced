...
public class RoslynHost : IRoslynHost
{
    ...
    private readonly ConcurrentDictionary<DocumentId, Action<DiagnosticsUpdatedEventArgs>> _diagnosticsUpdatedNotifiers;
    ...
    protected static IEnumerable<Type> GetDefaultCompositionTypes() => DefaultCompositionTypes;

    protected static ParseOptions CreateDefaultParseOptions() => new CSharpParseOptions(
    ...
    private void OnDiagnosticsUpdated(object? sender, DiagnosticsUpdatedEventArgs diagnosticsUpdatedArgs)
    {
