...
public static class Helpers
{
    ...
    public static async Task<SynchronizationContext> CreateWpfDispatcherAsync()
    {
        ...
        var dispatcherSyncContextCtor = Array.Find(windowsBaseAssembly.GetType("System.Windows.Threading.DispatcherSynchronizationContext", throwOnError: true)!
            .GetConstructors(), c => c.GetParameters() is var p && p.Length == 1 && p[0].ParameterType.Name == "Dispatcher") ?? throw new InvalidOperationException();
