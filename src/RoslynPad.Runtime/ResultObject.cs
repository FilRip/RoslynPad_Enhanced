...
internal class ResultObject
{
    ...
    private static string GetSimpleTypeName(Type type)
    {
        ...
        if (type.IsConstructedGenericType)
        {
            ...
            if (separatorIndex > 0)
            {
                typeName = typeName[..separatorIndex];
            }
    ...
    private string GetString(object o)
    {
        ...
        return s.Length > _quotas.MaxStringLength ? s[.._quotas.MaxStringLength] : s;
    }
}

internal sealed class ExceptionResultObject : ResultObject
{
...
internal sealed class ProgressResultObject
{
