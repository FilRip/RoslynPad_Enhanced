...
#pragma warning restore CS8618 // Un champ non-nullable doit contenir une valeur non-null lors de la fermeture du constructeur. Envisagez de déclarer le champ comme nullable.
    ...
    void AttachInternal(TextArea textArea)
    {
        ...
        CommandBindings.Add(new CommandBinding(SearchCommandsExtend.ReplaceNext, (sender, e) => ReplaceNext(), (sender, e) => e.CanExecute = IsReplaceMode));
        CommandBindings.Add(new CommandBinding(SearchCommandsExtend.ReplaceAll, (sender, e) => ReplaceAll(), (sender, e) => e.CanExecute = IsReplaceMode));
    ...
    private sealed class SearchReplaceInputHandler : TextAreaInputHandler
    {
        ...
        private void RegisterCommands()
        {
            ...
            CommandBindings.Add(new CommandBinding(SearchCommandsExtend.ReplaceNext, ExecuteReplaceNext, CanExecuteWithOpenSearchPanel));
            CommandBindings.Add(new CommandBinding(SearchCommandsExtend.ReplaceAll, ExecuteReplaceAll, CanExecuteWithOpenSearchPanel));
...
public static class SearchCommandsExtend
{
