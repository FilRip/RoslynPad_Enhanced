...
internal sealed class DeferredQuickInfoContentProvider : IDeferredQuickInfoContentProvider
{
    ...
    private sealed class QuickInfoDisplayDeferredContent(IDeferredQuickInfoContent? symbolGlyph, IDeferredQuickInfoContent? warningGlyph, IDeferredQuickInfoContent mainDescription, IDeferredQuickInfoContent documentation, IDeferredQuickInfoContent typeParameterMap, IDeferredQuickInfoContent anonymousTypes, IDeferredQuickInfoContent usageText, IDeferredQuickInfoContent exceptionText) : IDeferredQuickInfoContent
    {
        ...
        {
            object? lwarningGlyph = null;
            if (_warningGlyph != null)
            {
                lwarningGlyph = _warningGlyph.Create();
            }

            object? lsymbolGlyph = null;
            if (_symbolGlyph != null)
            {
                lsymbolGlyph = _symbolGlyph.Create();
            }

            return new QuickInfoDisplayPanel(
                lsymbolGlyph as FrameworkElement,
                lwarningGlyph as FrameworkElement,
    ...
    private sealed class SymbolGlyphDeferredContent(Glyph glyph) : IDeferredQuickInfoContent
    {
        public object Create()
        {
            var image = new Image
    ...
    private sealed class ClassifiableDeferredContent(IList<TaggedText> content) : IDeferredQuickInfoContent
    {
    ...
    private sealed class DocumentationCommentDeferredContent(string? documentationComment) : IDeferredQuickInfoContent
    {
